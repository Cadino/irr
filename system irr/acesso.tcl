...
#  Sep 27, 2020 09:14:12 AM CAT  platform: Linux
set vTcl(timestamp) ""
...
proc vTclWindow.top44 {base} {
    ...
    vTcl::widgets::core::toplevel::createCmd $top -class Toplevel \
        -background #fff -highlightcolor black 
    wm focusmodel $top passive
    wm geometry $top 490x309+504+117
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    entry $top.ent46 \
        ...
        -selectforeground white -width 286 
    vTcl:DefineAlias "$top.ent46" "edt_pass" vTcl:WidgetProc "Toplevel1" 1
    button $top.but47 \
        -activebackground #f9f9f9 -activeforeground black \
        -background $vTcl(actual_gui_bg) -font TkDefaultFont \
        -foreground $vTcl(actual_gui_fg) -highlightcolor black -text Entrar 
    vTcl:DefineAlias "$top.but47" "btn_entrypass" vTcl:WidgetProc "Toplevel1" 1
    button $top.but48 \
        -activebackground #f9f9f9 -activeforeground black \
        -background $vTcl(actual_gui_bg) -font TkDefaultFont \
        -foreground $vTcl(actual_gui_fg) -highlightcolor black -text Cancelar 
    vTcl:DefineAlias "$top.but48" "btn_cancelar" vTcl:WidgetProc "Toplevel1" 1
    label $top.lab49 \
        -activebackground #f9f9f9 -activeforeground black -background #fff \
        -font TkDefaultFont -foreground #ff0000 -highlightcolor black 
    ...
    label $top.lab47 \
        ...
        -image rsz_1lock_gif -text Label 
    vTcl:DefineAlias "$top.lab47" "Label3" vTcl:WidgetProc "Toplevel1" 1
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.lab45 \
        -in $top -x 0 -relx 0.204 -y 0 -rely 0.421 -width 0 -relwidth 0.3 \
        -height 0 -relheight 0.107 -anchor nw -bordermode ignore 
    place $top.ent46 \
        -in $top -x 0 -relx 0.224 -y 0 -rely 0.518 -width 286 -relwidth 0 \
    ...
    place $top.but48 \
        ...
        -anchor nw -bordermode ignore 
    place $top.lab49 \
        -in $top -x 0 -relx 0.633 -y 0 -rely 0.421 -width 0 -relwidth 0.21 \
        -height 0 -relheight 0.087 -anchor nw -bordermode ignore 
    place $top.lab47 \
        -in $top -x 0 -relx 0.394 -y 0 -rely 0.045 -width 0 -relwidth 0.222 \
