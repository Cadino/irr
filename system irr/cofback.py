...
#    Aug 28, 2020 09:01:05 PM CAT  platform: Linux
    ...
    def __init__(self, top=None):
        ...
        def ableUsingTime():
            if (var1.get() == 1):
                ...
                self.lbl_pont.configure(state='normal')
            elif (var1.get() == 0):
                ...
                self.lbl_pont.configure(state='disabled')
        ...
        def do_backspace(event):
            self.edt_hum.delete(0,2)

            return "break"

        def do_validation_time(event):
            

            return "break"

        def do_backspace_time(event):
            self.edt_tempo_hora.delete(0,2)
        ...
        c=top.register(callback)
        cT=top.register(callbackTem)
        self.edt_hum = tk.Entry(top, validate ="key", validatecommand =(c,'%P'))
        ...
        self.edt_hum.bind("<BackSpace>", do_backspace)
        ...
        self.edt_tempo_hora = tk.Entry(top, validate ="key", validatecommand =(cT,'%P'))
        self.edt_tempo_hora.place(relx=0.272, rely=0.667,height=31, relwidth=0.067)
        ...
        self.edt_tempo_hora.bind("<BackSpace>", do_backspace_time)

        self.edt_tempo_min = tk.Entry(top, validate ="key", validatecommand =(cT,'%P'))
        self.edt_tempo_min.place(relx=0.392, rely=0.667,height=31, relwidth=0.067)
        ...
        self.lbl_pont = tk.Label(top, )
        self.lbl_pont.place(relx=0.358, rely=0.690, height=14, width=1)
        self.lbl_pont.configure(activebackground="#f9f9f9")
        self.lbl_pont.configure(background="#fff")
        self.lbl_pont.configure(justify='left')
        self.lbl_pont.configure(text=''':''') 
        self.lbl_pont.configure(font="-family {Droid Serif} -size 16 -weight bold -slant roman -underline 0 -overstrike 0")  
        self.lbl_pont.configure(state='disabled')            
        ...
        self.btn_add.place(relx=0.493, rely=0.667, height=39, width=69)
